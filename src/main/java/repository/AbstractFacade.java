...
public abstract class AbstractFacade<T> {
    ...
    public T findByPk(long pk){
        LOGGER.info("IN findByPk:(entity = [{}])", entity);
        T result = entityManager.find(entity, pk);
        LOGGER.debug("OUT findByPk: returned [{}]", entity.getSimpleName());
        return result;
    }
...
//    todo do I need this ?
    ...
    public List<T> findAll(){
        ...
        List<T> result = entityManager.createQuery("from " + entity.getName()).getResultList();
     ...
     * */
    public int countAll() {
        LOGGER.info("IN countAll:(entity = [{}])", entity);
